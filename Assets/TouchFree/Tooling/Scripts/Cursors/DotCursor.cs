    ...
    public class DotCursor : TouchlessCursor
    {
        ...
        public virtual void UpdateCursor(Vector2 _screenPos, float _progressToClick)
        {
            ...
            if (hidingCursor)
            {
                ...
                ringImage.color = new Color(secondaryColor.r, secondaryColor.g, secondaryColor.b, 0);
            }
            else
            {
        ...
        void ScaleRing(float _progressToClick)
        {
            ...
            ringImage.color = new Color(secondaryColor.r, secondaryColor.g, secondaryColor.b, Mathf.Lerp(1f * secondaryColor.a, 0f, _progressToClick));
        ...
        public override void SetColors(Color _primary, Color _secondary, Color _tertiary)
        {
            ...
            ringImage.color = new Color(secondaryColor.r, secondaryColor.g, secondaryColor.b, ringImage.color.a);
        }
